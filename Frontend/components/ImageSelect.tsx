    ...
    return (
        <View>
            {imageUri==null && <View style={{width: 300, height: 200, flexDirection: 'row', alignItems: 'center', backgroundColor: 'lightgrey', borderColor: 'grey', borderWidth: 2, borderRadius: 10}}>
                ...
                <Pressable onPress={()=>{pickImage()}} style={{width: disableCamera ? '100%' : '50%', height: '100%', justifyContent: 'center', alignItems: 'center', borderLeftWidth: !disableCamera && 1, borderLeftColor: !disableCamera && 'lightgrey'}}>
